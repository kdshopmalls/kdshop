...
public class ProductController {
	...
	public void pro_list(SearchCriteria cri, @ModelAttribute("cate_name") String cate_name,
			@ModelAttribute("cate_code") Integer cate_code, Model model) throws Exception {
	...
	public void pro_detail(Integer item_num, @ModelAttribute("cate_name") String cate_name, Model model)
			throws Exception {
